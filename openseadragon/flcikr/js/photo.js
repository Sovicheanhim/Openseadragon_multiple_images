(function() {
    ...
    // ----------
    var component = App.Photo = function(config) {
      var self = this;
      ...
      var tileDrawnHandler = function(event) {
        if (event.tiledImage === self.tiledImage) {
          App.viewer.removeHandler('tile-drawn', tileDrawnHandler);
          self.drawn = true;
          App.photos.push(self);
      ...
      App.viewer.addHandler('tile-drawn', tileDrawnHandler);
    ...
    component.prototype = {
      ...
      frame: function() {
        ...
        if (this.width < this.targetWidth || this.height < this.targetHeight) {
          ...
          this._update();
        } else if (!this.textItem && !App.isTouch) {
          var restOpacity = 0.6;
  
          this.textItem = new App.TextItem({
